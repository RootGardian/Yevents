  ...
  return (
    <div className="max-w-4xl mx-auto text-center space-y-12 py-12 animate-in fade-in duration-1000">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8">
        ...
        <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl hover:border-ynov/50 transition-colors group shadow-sm dark:shadow-none">
          ...
          <a 
            ...
            className="text-slate-500 dark:text-slate-400 text-xs font-semibold hover:text-ynov transition-colors underline underline-offset-4 decoration-slate-200 dark:decoration-slate-800"
          >
        ...
        <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl hover:border-ynov/50 transition-colors group shadow-sm dark:shadow-none">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-xs font-semibold">PROFESSIONELS & ÉTUDIANTS YNOV</p>
        </div>
      </div>
      ...
      <div className="pt-8 bg-slate-50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800/50 p-10 rounded-[3rem] space-y-6 shadow-inner dark:shadow-none">
        ...
        <div className="pt-4 border-t border-slate-200/50 dark:border-slate-800/50 w-full max-w-md mx-auto">
          <Link to="/mes-inscriptions" className="flex items-center justify-center gap-2 text-[10px] sm:text-xs font-black uppercase tracking-[0.2em] text-slate-500 hover:text-ynov transition-colors group">
